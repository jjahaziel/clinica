...
class PacientesControllerTest < ActionController::TestCase
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post :create, paciente: { numero_paciente: @paciente.numero_paciente, persona_id: @paciente.persona_id }
    end
  ...
  test "should update paciente" do
    patch :update, id: @paciente, paciente: { numero_paciente: @paciente.numero_paciente, persona_id: @paciente.persona_id }
    assert_redirected_to paciente_path(assigns(:paciente))
  end
